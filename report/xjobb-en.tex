...
\foreigntitle{Evolution av artificiella hjÃ¤rnor vid simulering av djurs beteende}
\author{Bjoern Tegelund\\Johan Wikstroem}
\date{November 2003}
\blurb{Bachelor's Thesis at CSC\\Supervisor: Petter Oegren\\Examiner: Maerten Bjoerkman}
...
% Detta avsnitt är lite stökigt, men har åtminstone med alla delar som behövs
...
% We are using the AP	A style of referencing
